...
public class HttpClient {
    ...
    public String put(String urlStr, String data, HashMap<String, String> headers) {
        ...
        try {
            ...
            text = "Hiba! A PUT művelet nem sikerült a REST API-n!";
            System.out.println(text);
        }
        return text;
    }
    public String tryPut(String urlStr, String data, HashMap<String, String> headers)
            throws IOException {
        URL url = new URL(urlStr);
        HttpURLConnection http = (HttpURLConnection) url.openConnection();
    ...
    public String delete(String urlStr, HashMap<String, String> headers) {
        ...
        try {
            ...
            text = "Hiba! A DELETE művelet nem sikerült a REST API-n";
            System.err.println(text);
        }
        return text;
    }
    public String tryDelete(String urlStr, HashMap<String, String> headers)
            throws IOException {
        URL url = new URL(urlStr);
        HttpURLConnection http = (HttpURLConnection) url.openConnection();
